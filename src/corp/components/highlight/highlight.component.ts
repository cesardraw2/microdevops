...
import { CorpHighlightService } from 'corp/components/highlight/highlight.service';

@Component({
    selector       : 'textarea[corp-highlight]',
    templateUrl    : './highlight.component.html',
    styleUrls      : ['./highlight.component.scss'],
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'corpHighlight',
    standalone     : true,
    imports        : [NgClass],
})
export class CorpHighlightComponent implements OnChanges, AfterViewInit
{
    @Input() code: string;
    @Input() lang: string;
    ...
    constructor(
        ...
        private _corpHighlightService: CorpHighlightService,
    ...
    private _highlightAndInsert(): void
    {
        ...
        this.highlightedCode = this._domSanitizer.sanitize(SecurityContext.HTML, this._corpHighlightService.highlight(this.code, this.lang));
