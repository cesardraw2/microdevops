...
@Component({
    selector     : 'corp-masonry',
    templateUrl  : './masonry.component.html',
    encapsulation: ViewEncapsulation.None,
    animations   : corpAnimations,
    exportAs     : 'corpMasonry',
    standalone   : true,
    imports      : [NgTemplateOutlet],
})
export class CorpMasonryComponent implements OnChanges, AfterViewInit
{
     ...
     * Constructor
     */
    constructor(private _corpMediaWatcherService: CorpMediaWatcherService)
    {
    }
