...
import { ScrollbarGeometry, ScrollbarPosition } from 'corp/directives/scrollbar/scrollbar.types';
 ...
 */
@Directive({
    selector  : '[corpScrollbar]',
    exportAs  : 'corpScrollbar',
    standalone: true,
})
export class CorpScrollbarDirective implements OnChanges, OnInit, OnDestroy
{
    /* eslint-disable @typescript-eslint/naming-convention */
    static ngAcceptInputType_corpScrollbar: BooleanInput;
    /* eslint-enable @typescript-eslint/naming-convention */

    @Input() corpScrollbar: boolean = true;
    @Input() corpScrollbarOptions: PerfectScrollbar.Options;
    ...
    {
        // Enabled
        if ( 'corpScrollbar' in changes )
        {
            // Interpret empty string as 'true'
            this.corpScrollbar = coerceBooleanProperty(changes.corpScrollbar.currentValue);

            // If enabled, init the directive
            if ( this.corpScrollbar )
            {
                this._init();
            }
        ...
        // Scrollbar options
        if ( 'corpScrollbarOptions' in changes )
        {
            // Merge the options
            this._options = merge({}, this._options, changes.corpScrollbarOptions.currentValue);
