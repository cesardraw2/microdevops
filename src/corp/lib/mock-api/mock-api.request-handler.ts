...
import { CorpMockApiReplyCallback } from 'corp/lib/mock-api/mock-api.types';
import { Observable, of, take, throwError } from 'rxjs';

export class CorpMockApiHandler
{
    request!: HttpRequest<any>;
    urlParams!: { [key: string]: string };

    // Private
    private _reply: CorpMockApiReplyCallback = undefined;
     ...
     * @param callback
     */
    reply(callback: CorpMockApiReplyCallback): void
    {
        // Store the reply
