...
export const services : IServiceContainer[] = [
    {
        ...
        isCreated: null,
        archType: null,
        sourcePath: 'desenv/projects/devops/microdevops-local/manager/ui/micro-devops-app/resources/manager/containers/tools/servers/proxy/traefik',
        isBackend: null,
        libs: [],
        category: 'tools/servers/proxy',
        isEnabled: true
    },
    {
        id   : '2',
        ...
        status: 'Waiting',
        serviceName: 'adminer',
        url: 'http://adminer.localhost/',
        order: 4,
        isCreated: null,
        archType: null,
        sourcePath: 'desenv/projects/devops/microdevops-local/manager/ui/micro-devops-app/resources/manager/containers/tools/db/adminer',
        isBackend: null,
        libs: [],
        category: 'tools/db',
        isEnabled: false
    },
    {
        ...
        isCreated: null,
        archType: null,
        sourcePath: 'desenv/projects/devops/microdevops-local/manager/ui/micro-devops-app/resources/manager/containers/tools/system/orchestration/portainer',
        isBackend: null,
        libs: [],
        category: 'tools/system/orchestration',
        isEnabled: true
    },
    {
        id   : '4',
        ...
        status: 'Waiting',
        serviceName: 'glances',
        url: 'http://system-monitor.localhost',
        order: 3,
        isCreated: null,
        archType: null,
        sourcePath: 'desenv/projects/devops/microdevops-local/manager/ui/micro-devops-app/resources/manager/containers/tools/system/monitoring/glances',
        isBackend: null,
        libs: [],
        category: 'tools/system/monitoring',
        isEnabled: true
    },
    {
        id   : '5',
        label: 'App001 - Frontend',
        serviceName: 'app001-frontend',
        status: 'Waiting',
        url: 'http://poc-angular.localhost',
        order: 5,
        isCreated: null,
        archType: 'angular',
        sourcePath: 'desenv/projects/devops/microdevops-local/manager/ui/micro-devops-app/resources/manager/containers/app/frontend/angular-poc-app',
        isBackend: false,
        libs: [],
        category: 'app/frontend/angular',
        isEnabled: true
    },
    {
        id   : '6',
        label: 'App001 - Backend',
        status: 'Waiting',
        serviceName: 'app001-backend',
        url: null,
        order: 7,
        isCreated: null,
        archType: null,
    ...
    },
    {
        ...
        status: 'Waiting',
        url: 'http://prometheus.localhost/graph',
        order: 11,
        isCreated: null,
        archType: null,
        sourcePath: 'desenv/projects/devops/microdevops-local/manager/ui/micro-devops-app/resources/manager/containers/tools/system/monitoring/prometheus',
        isBackend: null,
        libs: [],
        category: 'tools/system/monitoring',
        isEnabled: false
    },
    {
        ...
        serviceName: 'jaeger',
        status: 'Waiting',
        url: 'http://jaeger.localhost/search',
        order: 12,
        isCreated: null,
        archType: null,
        sourcePath: 'desenv/projects/devops/microdevops-local/manager/ui/micro-devops-app/resources/manager/containers/tools/system/monitoring/jaeger',
        isBackend: null,
        libs: [],
        category: 'tools/system/monitoring',
        isEnabled: false
    ...
    {
        id   : '13',
        label: 'Sicoob Seguros - Backoffice',
        status: 'Waiting',
        serviceName: 'sicoob-seguros-backoffice',
        url: null,
        order: 2,
        isCreated: null,
        archType: 'open-liberty',
        sourcePath: `desenv/projects/sicoob/seguros/sicoobseguros/EAR/Backoffice`,
        isBackend: true,
        libs: [],
        category: 'app/backend/java',
        isEnabled: false,
        hosts: ['DB2D305']
    },
    {
        id   : '14',
        label: 'POC Open -Liberty',
        status: 'Waiting',
        serviceName: 'poc-open-liberty',
        url: null,
        order: 15,
        isCreated: null,
        archType: 'open-liberty',
    ...
    {
        id   : '15',
        label: '[POC] Plataforma - Frontend',
        serviceName: 'poc-plataforma-frontend',
        status: 'Waiting',
        url: 'http://poc-plataforma.localhost',
        order: 5,
        isCreated: null,
        archType: 'angular',
        sourcePath: 'desenv/projects/devops/microdevops-local/manager/ui/micro-devops-app/resources/manager/containers/app/frontend/poc-plataforma-app',
        isBackend: false,
        libs: [],
        category: 'app/frontend/angular',
        isEnabled: true
