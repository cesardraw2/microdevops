...
import { CorpNavigationItem, CorpNavigationService } from 'corp/components/navigation';
...
import { services } from 'app/mock-api/apps/micro-devops/service-conteiners/data';
...
{
    private readonly _defaultNavigation: CorpNavigationItem[] = defaultNavigation;
    private readonly _contacts: any[] = contacts;
    private readonly _tasks: any[] = tasks;
    private readonly _services: any[] = services;

    /**
     * Constructor
     */
    constructor(
        private _corpMockApiService: CorpMockApiService,
    ...
    registerHandlers(): void
    {
        ...
        const flatNavigation = this._corpNavigationService.getFlatNavigation(this._defaultNavigation);
        ...
        this._corpMockApiService
            ...
            .reply(({request}) =>
            {
                ...
                // Filter the services
                const servicesResults:ServiceConteiner[] = cloneDeep(this._services)
                ...
                {
                    // Normalize the results
                    servicesResults.forEach((result:ServiceConteiner) =>
                    {
                        // Add the title as the value
