...
export class LayoutComponent implements OnInit, OnDestroy
{
    ...
    constructor(
        ...
        private _corpConfigService: CorpConfigService,
        private _corpMediaWatcherService: CorpMediaWatcherService,
        private _corpPlatformService: CorpPlatformService,
    )
    {
    }
    ...
    ngOnInit(): void
    {
        ...
        combineLatest([
            this._corpConfigService.config$,
            this._corpMediaWatcherService.onMediaQueryChange$(['(prefers-color-scheme: dark)', '(prefers-color-scheme: light)']),
        ]).pipe(
        ...
        // Set the app version
        this._renderer2.setAttribute(this._document.querySelector('[ng-version]'), 'corp-version', CORP_VERSION);

        // Set the OS name
        this._renderer2.addClass(this._document.body, this._corpPlatformService.osName);
    }
